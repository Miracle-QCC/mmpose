...
def parse_args():
    ...
    parser.add_argument('--onnx_file', help='ONNX file path', default='/home/qcj/workcode/mmpose/onnx/rtmpose_t.onnx')
    parser.add_argument('--image_file', help='Input image file path',default='/home/qcj/workcode/mmpose/tools/260.jpg')
    parser.add_argument(
